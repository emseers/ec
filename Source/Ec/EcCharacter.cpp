...
void AEcCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AEcCharacter::OnResetVR);
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AEcProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
//void AEcCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
